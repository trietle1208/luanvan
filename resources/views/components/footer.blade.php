            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="companyinfo">
                        <h2><span>T</span>-shopper</h2>
                        <p>Nơi mua sắm các linh, phụ kiện máy tính chất lượng từ các nhà cung cấp uy tín.</p>
                    </div>
                </div>
                <div class="col-sm-10">
                    <div class="col-sm-3">
