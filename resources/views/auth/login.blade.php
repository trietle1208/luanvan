                            ...
                            <div class="card-body p-4">
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control @error('email') is-invalid @enderror" type="email" id="emailaddress" name="email" value="{{ old('email') }}" required="" placeholder="Nhập vào tài khoản Email">
                                        @error('email')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="password" id="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Nhập vào mật khẩu">
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="checkbox-signin">Ghi nhớ</label>
                                        </div>
                                    </div>
                                ...
                                <div class="text-center">
                                    <h5 class="mt-3 text-muted">Đăng nhập với</h5>
