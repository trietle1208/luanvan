...
<html lang="en">
    ...
    <body class="loading authentication-bg authentication-bg-pattern"><script id="__bs_script__">//<![CDATA[
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    <h3 class="mt-4">Bạn không có quyền truy cập </h3>
                                    <p class="text-muted mb-0">Tài khoản của bạn hiện đang bị tạm khóa, vui lòng trở lại khi được người quản trị cấp quyền lại.</p>
                                </div>
