...
@section('content')
    <div class="col-lg-12 pt-5">
        <div class="card">
            <div class="card-body">
                    <h2 class="header-title text-center">CẬP NHẬT THÔNG SỐ SẢN PHẨM</h2>
                <?php
                ...
                ?>
                <form class="form-horizontal" action="{{ route('admin.para.update', ['id' => $parameters->ts_id]) }}" method="post">
                    @csrf
                    <div class="row mb-3">
                        ...
                        <div class="col-8 col-xl-9">
                            <input type="text" class="form-control" id="inputPassword3"
                                   name="name"
                                    value="{{ $parameters['ts_tenthongso'] }}"
